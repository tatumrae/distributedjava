<%-- 
    Document   : index
    Created on : Feb 12, 2018, 7:41:23 PM
    Author     : tatum
--%>
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-3">
            <div class="card">
                ...
                <div class="card-body">
                    <h4 class="card-title text-center"><a href="productDetail.jsp" title="View Product">Donkey "Burros" Tail</a></h4>
                    <div class="row">
                        <div class="col">
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title"><a href="productDetail.jsp" title="View Product">Echeveria 'Perle Von Nürnberg'</a></h4>
...
<p>The leaves overlap nicely in 5 to 6 inch wide solitary rosettes that eventually grow up on a slender stem. The flowers, which appear in summer on 1 foot long reddish-stemmed inflorescences, are a corral pink color on the exterior with a yellow interior.</p>
                        ...
                        <div class="col-sm">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title"><a href="productDetail.jsp" title="View Product">Powder Puff Graptoveria</a></h4>
                        ...
                        <div class="col-sm">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title"><a href="productDetail.jsp" title="View Product">Echeveria 'Black Prince'</a></h4>
...
<p>These leaves first emerge greenish but darken to a deep lavender brown and with age the lower leaves widen out to as much as 1 inch at the base with an acuminate tip that has fine yellow edges. In late fall to early winter appear the dark red flowers on short stalks.</p>
                        ...
                        <div class="col-sm">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title"><a href="productDetail.jsp" title="View Product">Jelly Bean</a></h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm">
                            <div class="card">
                                ...
                                <img src="" alt=""/>
                                <div class="card-body">
                                    <h4 class="card-title"><a href="productDetail.jsp" title="View Product">Sedeveria Jet Bead</a></h4>
                        ...
                        <div class="col-sm">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title"><a href="productDetail.jsp" title="View Product">Zebra Haworthia</a></h4>
