            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title"><a href="product.jsp" title="View Product">Sedevaria Jet Bead</a></h4>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <div class="row">
                                <div class="col">
                                    <p class="btn btn-danger btn-block">$1.90</p>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title"><a href="product.jsp" title="View Product">String of Pearls</a></h4>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <div class="row">
                                <div class="col">
                                    <p class="btn btn-danger btn-block">$2.40</p>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title"><a href="product.jsp" title="View Product">Panda Ear</a></h4>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <div class="row">
                                <div class="col">
                                    <p class="btn btn-danger btn-block">$2.40</p>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title"><a href="product.jsp" title="View Product">Donkey "Burros" Tail</a></h4>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <div class="row">
                                <div class="col">
                                    <p class="btn btn-danger btn-block">$1.90</p>
